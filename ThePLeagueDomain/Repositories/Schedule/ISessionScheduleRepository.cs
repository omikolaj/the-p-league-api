...
namespace ThePLeagueDomain.Repositories.Schedule
{
    public interface ISessionScheduleRepository
    {
        ...
        Task<bool> UpdateSessionScheduleAsync(LeagueSessionSchedule leagueSessionScheduleToUpdate, CancellationToken ct = default(CancellationToken));
        ...
        Task<List<LeagueSessionSchedule>> GetAllSessionsByLeagueIdAsync(string leagueId, CancellationToken ct = default(CancellationToken));
